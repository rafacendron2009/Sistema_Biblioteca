    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Rprojetos<sup><small><span class="label label-info">v.0</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=rent"><i class="fa fa-cube"></i> Emprestimo</a></li>
          <li><a href="index.php?view=rents"><i class="fa fa-th-large"></i> Empréstimos</a></li>
          <li><a href="index.php?view=books"><i class="fa fa-book"></i> Livros</a></li>
          ...
          <li><a href="index.php?view=editorials"><i class="fa fa-th-list"></i> Editoras</a></li>
          <li><a href="index.php?view=authors"><i class="fa fa-th-list"></i> Autores</a></li>
          <?php if($u->is_admin):?>
          <li><a href="index.php?view=reports"><i class="fa fa-area-chart"></i> Relatórios</a></li>
...
if(Session::getUID()!=""){
  ...
  $user = $u->name." ".$u->lastname;
        ...
        <ul class="dropdown-menu">
          <li><a href="index.php?view=configuration">Configuração</a></li>
