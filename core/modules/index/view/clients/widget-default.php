...
<div class="btn-group pull-right">
	<a href="index.php?view=newclient" class="btn btn-default"><i class='fa fa-male'></i> Novo Cliente</a>
<!--<div class="btn-group pull-right">
...
<br>
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<a href="index.php?view=clienthistory&id=<?php echo $user->id;?>" class="btn btn-default btn-xs">Historico</a>
